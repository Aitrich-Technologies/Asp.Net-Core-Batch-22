...
namespace Domain.Migrations
{
    ...
    [Migration("20260128104404_Jobseeker updated in models")]
    partial class Jobseekerupdatedinmodels
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Domain.Models.JobSeeker", b =>
                {
                    ...
                    b.Property<Guid?>("SystemUserId1NavigationId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("SystemUserId1NavigationId")
                        .IsUnique()
                        .HasFilter("[SystemUserId1NavigationId] IS NOT NULL");
            ...
            modelBuilder.Entity("Domain.Models.JobSeeker", b =>
                {
                    ...
                    b.HasOne("Domain.Models.SystemUser", "SystemUserId1Navigation")
                        ...
                        .HasForeignKey("Domain.Models.JobSeeker", "SystemUserId1NavigationId");
